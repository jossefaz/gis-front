...
export default (props) => {
    ...
    const toggleRowHighlight = (overlay, leave) => {
        const overlayDiv = document.querySelector(`#${props.overlays[overlay].selector}`)
                        ...
                        <Body>
                            {
                                props.overlays ? Object.keys(props.overlays).map((overlay, index) =>
                                    ...
                                    >
                                        <TextItem removeOverlay={props.removeOverlay} index={index} id={overlay} content={props.overlays[overlay].content} editText={props.editText} />
                                    </Row>
                                ) : null
                            }
                        </Body>
